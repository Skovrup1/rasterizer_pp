...
void draw_texel(i32 x, i32 y, Vec4 a, Vec4 b, Vec4 c, Vec2 a_uv, Vec2 b_uv,
                Vec2 c_uv, const u32 *texture) {
...
void draw_textured_triangle_g(i32 x0, i32 y0, f32 z0, f32 w0, f32 u0, f32 v0, //
                            i32 x1, i32 y1, f32 z1, f32 w1, f32 u1, f32 v1, //
                            i32 x2, i32 y2, f32 z2, f32 w2, f32 u2, f32 v2,
                            const u32 *texture) {
    if (y0 >= y2) {
